package com.arquitetura.estoque.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Pedido> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.TYPE_MAPPINGS, "pedido:com.arquitetura.estoque.model.Pedido");
        configProps.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.arquitetura.estoque.model.Pedido");
