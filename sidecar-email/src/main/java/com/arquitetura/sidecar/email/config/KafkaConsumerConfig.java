package com.arquitetura.sidecar.email.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Pedido> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.TYPE_MAPPINGS, "pedido:com.arquitetura.sidecar.email.model.Pedido");
        configProps.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.arquitetura.sidecar.email.model.Pedido");
